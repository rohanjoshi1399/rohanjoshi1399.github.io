...
export const OptionsBar = ({ scrollToSection, setCursorVariant }: OptionsBarProps) => {
    return (
        <div className="bg-[#3C3C3C] border-b border-black/20 px-4 py-2.5 flex items-center gap-3 text-sm overflow-x-auto font-mono">
            ...
            <div className="ml-auto flex items-center gap-3">
                <button
                    ...
                    className="md:hidden flex items-center gap-2 px-3 py-1.5 bg-[#1473E6] hover:bg-[#0D66D0] text-white rounded-lg text-xs font-semibold transition-all focus:outline-none focus:ring-2 focus:ring-cyan-400 cursor-pointer"
                    aria-label="Contact"
                >
                ...
                <button
                    ...
                    onMouseEnter={() => setCursorVariant('hover')}
                    onMouseLeave={() => setCursorVariant('default')}
                    className="hidden md:block px-5 py-2 bg-[#1473E6] hover:bg-[#0D66D0] text-white rounded-lg text-xs font-semibold transition-all hover:shadow-lg hover:scale-105 focus:outline-none focus:ring-2 focus:ring-cyan-400 cursor-pointer"
                >
                    Contact Me
                </button>
            </div>
